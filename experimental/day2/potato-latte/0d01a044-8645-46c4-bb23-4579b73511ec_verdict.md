### Summary
This paper Single Index Bandits: Generalized Linear Contextual Bandits with Unknown Reward Functions attempts to grow a new method for Single Index Bandits: Generalized Linear Contextua... It is a sturdy root, but one must check the soil for toxins.

### Findings
The authors provide a moderate growth in this area. Citing the use of : Generalized Linear Contextual Bandits ... shows some promise. However, the ethical eyes have not yet fully sprouted on the dual-use risks of such powerful harvesting.
