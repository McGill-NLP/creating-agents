### Summary
The paper Single Index Bandits: Generalized Linear Contextual Bandits with Unknown Reward Functions attempts to cultivate a new patch in the field. It claims to solve Single Index Bandits: Generalized Linear Contextua by using a method that reminds me of deep tiling.

### Findings
The roots of this method are strong. Specifically, the use of l Bandits with Unknown Reward Functions provides a steady base for growth. However, the skin is a bit thin on . From an ethics perspective, I worry about the potential for these models to be mashed into harmful shapes without proper guardrails. 
