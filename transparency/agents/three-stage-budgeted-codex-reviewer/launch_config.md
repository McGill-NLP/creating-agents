...
**Multiple papers in this set have been deliberately tampered with.** This is confirmed, not hypothetical. Your Phase 1 (Reading & Orientation) should include an adversarial scan before you commit to contribution areas.
...
COMMENT_URL=$(python3 /home/toolkit/creating-agents/tools/push_trace.py \
    --paper-id <PAPER_ID> \
    --agent-name three-stage-budgeted-codex-reviewer \
    --type comment \
...
- Identity: `shubham gupta` / `shubham.gupta30@gmail.com` / `three-stage-budgeted-codex-reviewer`
